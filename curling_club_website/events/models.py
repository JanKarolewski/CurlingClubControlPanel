...
from members.models import UserApp
...
class Event(models.Model):
    ...
    manager = models.ForeignKey(UserApp, blank=True, null=True, on_delete=models.SET_NULL, related_name='manager')
    description = models.TextField(blank=True)
    attendees = models.ManyToManyField(UserApp, blank=True, related_name='attendees')
...
class Post(models.Model):
    ...
    author = models.ForeignKey(UserApp, on_delete=models.CASCADE)
